...
df_train = pd.read_csv('/home/antosha/project/scripts/datasets/X_train.csv', index_col=0)
df_test = pd.read_csv('/home/antosha/project/scripts/datasets/X_test.csv', index_col=0)
...
#Сохранение файлов
X_train.to_csv('/home/antosha/project/scripts/datasets/X_train.csv', index=False)
X_test.to_csv('/home/antosha/project/scripts/datasets/X_test.csv', index=False)
